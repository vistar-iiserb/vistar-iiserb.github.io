...
const VideoSection = ({
  ...
  return (
    <>
      <h1 className={"ml-12 text-4xl font-bold mt-12 text-black  "}>
        Our Latest Blogs
      </h1>
      <div
        className={classNames(
          "grid grid-cols-1 md:grid-cols-2 p-8 gap-12 mt-12",
          className
        )}
      >
        <div className={classNames("bg-white ")}>
          <h1 className="ml-12 text-4xl font-bold mt-12 text-black font-sfheavy">
            Watch our latest Podcast on{" "}
            <span className="text-blue-500">AI in MedTech</span>
          </h1>
          <p className="font-sfregular text-xl mt-6 ml-12 mr-8 text-gray-500">
