                    ...
                    <motion.div
                        ...
                        <div className={` flex flex-col  z-[10] md:w-[50%] mx-auto mt-12 `}>
                            ...
                            <h1 className="font-bold  text-center items-center  flex flex-col md:mt-0 mt-24">
                                ...
                                <span
                                    className={'tracking-tight shadow-md bg-gradient-to-br from-white via-neutral-500 to-neutral-200  bg-clip-text text-transparent lg:text-9xl text-7xl text-center   px-3 py-1 w-fit rounded-xl  '}>
                                    VISTAR
                                </span>
                                <span
