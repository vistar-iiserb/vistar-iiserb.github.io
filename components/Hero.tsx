    ...
    // <PageWrapper>
      <div className="min-h-screen    relative">
        <div className="  text-center bg-white w-full z-[999] h-screen flex flex-col   ">
          ...
          <div className="w-full  items-center flex md:flex-row flex-col justify-between h-[80%]   text-gray-800  bg-white  font-bold text-2xl text-left  ">
            <div className="flex flex-col  p-6 md:p-12 justify-between ">
              <div className={` flex flex-col z-[10] md:w-[60%] mt-12 `}>
    {/*VISTAR ARTIFICIAL*/}
                  <h1 className=" ml-2  lg:text-5xl text-5xl  md:mt-0 mt-24">
                ...
                <p className="mt-4 ml-2  text-gray-500 text-medium ">
            ...
            {/*<img src={'brain.jpg'} className={'w-[35%] object-cover aspect-square rounded-xl'} />*/}
            </div>
